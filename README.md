...
| ESP/Arduino library version | sonoff | classic | minimal | knx  | allsensors | Remark
|-----------------------------|--------|---------|---------|------|------------|-------------------------------
| ESP/Arduino lib v2.3.0      | 529k   | 490k    | 429k    | 538k | 554k       | Preferred and released version
| ESP/Arduino lib v2.4.0      | 534k   | 498k    | 436k    | 542k | 558k       | Wifi and Alexa issues
| ESP/Arduino lib v2.4.1      | 536k   | 501k    | 439k    | 545k | 560k       | Wifi and Alexa issues
